...
import 'package:flutter_basics_workbook/number_trivia/domain/repositories/number_trivia_repository.dart';
...
void main() {
  ...
  final tNumber = 1;
  final tNumberTrivia =
      NumberTrivia(number: 1, text: 'test', type: NumberType.trivia);
